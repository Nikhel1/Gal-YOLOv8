...
def convert_coco_json(json_dir='../coco/annotations/', use_segments=False, use_keypoints=False, cls91to80=False, savedir_path='../yolo/YOLO_RadioGalaxyNET_V4'):
    save_dir = savedir_path #make_dirs()  # output directory
